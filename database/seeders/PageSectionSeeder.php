...
class PageSectionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        PageSection::create([
            ...
            "order" => 7,
            "active" => 1,
            "content" => '                     <h3>BIDANG UMUM</h3>                     <ul>                         <li>Pelantikan Ketua TP. PKK Periode Tahun 2025 â 2029</li>                         <li>Pengembangan APLIKASI E â PKK</li>                         <li>Puncak Acara Peringatan HKG-PKK KE-52 di Bangkalan</li>                         <li>Pembinaan 10 Program Pokok PKK</li>                         <li>Rapat Koordinasi TP.PKK Kabupaten dan TP. PKK Kecamatan</li>                         <li>Rapat Koordinasi TP.PKK Kabupaten dengan OPD terkait</li>                     </ul>                      <h3>POKJA 1</h3>                     <h4>CEPAK</h4>                     <ul>                         <li>Cegah Pernikahan Anak/Dini</li>                         <li>Bimbingan Pranikah</li>                     </ul>                      <h4>PAAREDI (Pola Anak-anak dan Remaja di Era Digital)</h4>                     <ul>                         <li>Keluarga Indonesia Sehat Tanpa Narkoba (KISAN)</li>                         <li>Keluarga Indonesia Sadar Administrasi Kependudukan (KISAK)</li>                         <li>Keluarga Indonesia Lindungi Anak dari Kekerasan Seksual (KILAS)</li>                         <li>Pembinaan Kesadaran Bela Negara (PKBN)</li>                         <li>Keluarga Indonesia Anti Trafficking (KIAT)</li>                     </ul>                      <h4>GOTONG ROYONG</h4>                     <ul>                         <li>Peningkatan kesadaran keluarga dalam membangun kerjasama antar keluarga</li>                         <li>Menambahkan sikap kesetiakawanan sosial</li>                         <li>Partisipasi dalam kegiatan bakti sosial di masyarakat</li>                         <li>Pengajian mohon dihidupkan kembali</li>                     </ul>                      <!-- Continue with POKJA 2, 3, and 4 in the same format -->                 ',
            "content_data" => json_encode([]),
        ]);
